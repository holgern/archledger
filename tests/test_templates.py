...
from archledger.model import RECORD_TYPE_TO_TEMPLATE
...
def test_all_record_templates_are_bundled() -> None:
    ...
    assert (template_root / "arc42_document.md.j2").is_file()
    for template_name in RECORD_TYPE_TO_TEMPLATE.values():
